...
map.getView().fit([460626.092019, 7749534.311595, 654235.837961, 7904383.921022], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Comunidades da Região 3 - Caracterização e Danos Coletivos</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_CaracterizaodasComunidades_3,
    colName: 'Comunidade',
    zoom: 10,
    collapsed: true,
    map: map
